...
//  kotlin("android")
//  kotlin("plugin.serialization") // ✅ 이게 핵심
...
//  alias(libs.plugins.kotlin.serialization) // ✅ 추가 (version catalog에 정의 필요)
//  id("org.jetbrains.kotlin.plugin.serialization") // ✅ Kotlin 2.x에서 보편적
